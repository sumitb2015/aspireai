      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PRODUCTS.map((product) => (
            <Link key={product.id} href={product.featuresUrl}>
              <Card className="group h-full border-none bg-gradient-to-br from-card to-muted/20 shadow-xl overflow-hidden cursor-pointer hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                ...
                <CardFooter className="px-8 md:px-12 pb-12">
                  <div className="flex flex-wrap gap-4 w-full">
                    <a href={product.url} target="_blank" rel="noopener noreferrer" className="flex-grow md:flex-grow-0" onClick={(e) => e.stopPropagation()}>
